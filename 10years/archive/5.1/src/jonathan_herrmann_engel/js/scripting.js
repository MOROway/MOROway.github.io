...
var trains =  [{src: 0, fac: 0.051, width: 0, height: 0, name:"Dampflok", speedInPercent: 50, circle: {}, circleFamily: {}, move: false, displayAngle: 0, standardDirection: true, icon: "🚂", switchCircles: false, bogieDistance: 0.15, x:0, y:0, front: {state: 1, currentCurveFac: 0, x:0, y:0, angle: 0}, back: {state: 1, currentCurveFac: 0, x:0, y:0, angle: 0}, cars:[{src: 1, fac: 0.060, width: 0, height: 0, displayAngle: 0, icon: "🚃", bogieDistance: 0.15, x:0, y:0, front: {state: 1, currentCurveFac: 0, x:0, y:0, angle: 0}, back: {state: 1, currentCurveFac: 0, x:0, y:0, angle: 0}},{src: 1, fac: 0.060, width: 0, height: 0, displayAngle: 0, icon: "🚃", bogieDistance: 0.15, x:0, y:0, front: {state: 1, currentCurveFac: 0, x:0, y:0, angle: 0}, back: {state: 1, currentCurveFac: 0, x:0, y:0, angle: 0}},{src: 1, fac: 0.060, width: 0, height: 0, displayAngle: 0, icon: "🚃", bogieDistance: 0.15, x:0, y:0, front: {state: 1, currentCurveFac: 0, angle: 0}, back: {state: 1, currentCurveFac: 0, angle: 0}},{src: 2, fac: 0.044, width: 0, height: 0, displayAngle: 0, icon: "🚃", bogieDistance: 0.15, x:0, y:0, front: {state: 1, currentCurveFac: 0, x:0, y:0, angle: 0}, back: {state: 1, currentCurveFac: 0, x:0, y:0, angle: 0}}]},{src:3,fac: 0.093,width: 0, height: 0,  name:"TGV Duplex", speedInPercent: 50, circle: {}, circleFamily: {}, move: false, adisplayAngle: Math.PI, standardDirection: false, icon: "🚅", switchCircles: false, bogieDistance: 0.15, x:0, y:0, front: {state: 3, currentCurveFac: 0, x:0, y:0, angle: Math.PI}, back: {state: 3, currentCurveFac: 0, x:0, y:0, angle: Math.PI}, cars:[{src: 4, fac: 0.11, width: 0, height: 0, displayAngle: Math.PI, icon: "🚃", bogieDistance: 0.15, x:0, y:0, front: {state: 3, currentCurveFac: 0, x:0, y:0, angle: Math.PI}, back: {state: 3, currentCurveFac: 0, x:0, y:0, angle: Math.PI}},{src: 5, fac: 0.11, width: 0, height: 0, displayAngle: Math.PI, icon: "🚃", bogieDistance: 0.15, x:0, y:0, front: {state: 3, currentCurveFac: 0, x:0, y:0, angle: Math.PI}, back: {state: 3, currentCurveFac: 0, x:0, y:0, angle: Math.PI}}, {src: 6, fac: 0.093, width: 0, height: 0, displayAngle: Math.PI, icon: "🚃", bogieDistance: 0.15, x:0, y:0, front: {state: 3, currentCurveFac: 0, x:0, y:0, angle: Math.PI}, back: {state: 3, currentCurveFac: 0, x:0, y:0, angle:Math.PI}}]},{src:7, fac: 0.068,width: 0, height: 0, name:"Schi-Stra-Bus", speedInPercent: 50, circle: {}, circleFamily: {}, move: false, displayAngle: 0,standardDirection: true, icon: "🚋", switchCircles: false, bogieDistance: 0.15, x:0, y:0, front: {state: 1, currentCurveFac: 0, x:0, y:0, angle: 0}, back: {state: 1, currentCurveFac: 0, x:0, y:0, angle: 0}, cars:[]}];
			...
			setTimeout(function(){
					...
					setTimeout(function(){
						...
						if(settings.classicUI && !settings.alwaysShowSelectedTrain){ 
							...
							notify('NEUE VERSION!', false, 7000, function(){followLink("whatsnew/#newest", "_blank", LINK_STATE_INTERNAL_HTML)}, 'Mehr Informationen', background.y);
						} else {
...
function animateObjects() {
 ...
 function animateTrains(input1){
  ...
  function setCOPosBezier(bezierPoints, isBackwards, length){
	 ...
	 cO.currentCurveFac = fac + backwardsCorr*((trains[input1].speed*trains[input1].speedInPercent/100)/length);					
