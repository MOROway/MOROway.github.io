...
const STRINGS = {
	en:{
		...
		platformOcStartGame: "Play", platformOcStartGameOnline: "Multiplayer", platformOcStartHelp: "Help/Legal", platformOcStartSettings: "Settings", platformOcStartSettingsOc: "More Settings", platformOcSettingsOptLandscapeAppTitle: "App: Allow screen rotation", platformOcSettingsOptLandscapeAppDesc: "If disabled app always displays in landscape mode.", platformOcSettingsOptLandscapeGameTitle: "Gameplay: Allow screen rotation", platformOcSettingsOptLandscapeGameDesc: "If disabled game always displays in landscape mode.", platformOcSettingsOptLandscapeGameInfo: "Limit orientation lock to gameplay.", platformOcGameLeave: "Leave and destroy game?", platformOcGameLeaveTitel: "Are you sure?", platformOcGameLeaveYes: "Leave!", platformOcGameLeaveNo: "Cancel!", platformWebSettingsIframeApplyAndClose: "Apply and close", platformWindowsLinkError: "Error! Couldn't open link.", platformWindowsAppScreenFeedback: "Feedback", platformWindowsAppScreenChangelog: "Changelog"},
	de:{
		langName: "Deutsch",
